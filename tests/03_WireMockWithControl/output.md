...
```
PS usage-wiremock\tests\03_WireMockWithControl> ..\..\server\server.ps1 .\scenario-server.csv http://localhost:12000 3
...
```
PS usage-wiremock\tests\03_WireMockWithControl> ..\..\client\client.ps1 .\scenario-client.csv
